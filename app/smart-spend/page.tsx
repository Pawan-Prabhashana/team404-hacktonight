...
function ScoreBadge({ score }: { score: number }) {
  ...
  return (
    <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
      ...
      <div>
        <p style={{ fontWeight: 700, color: '#071f2a', fontSize: '0.875rem' }}>
          {label}
        </p>
...
export default function SmartSpendPage() {
  ...
  const [twinScenario, setTwinScenario] = useState<
    'purchase' | 'saving' | 'bill_payment' | 'transfer'
  >('purchase')
  ...
  useEffect(() => {
    ...
    if (!user) {
      router.push('/login?next=/smart-spend')
      return
    }
    load()
    ...
    >
      ...
      >
        ...
        >
          ...
          {m ? (
            <ScoreBadge score={m.financialHealthScore} />
          ) : (
                    ...
                    <div key={cat.slug}>
                      ...
                      {cat.budgetDisplay && (
                        ...
                        >
                          ...
                          {cat.budgetUsedPct !== undefined &&
                            ` — ${cat.budgetUsedPct}% used`}
                        </p>
                      )}
                    </div>
                  ))}
                ...
                {budgetMsg && (
                  <p
                    style={{
                      fontSize: '0.8rem',
                      color:
                        budgetMsg === 'Budget saved.' ? '#087f7a' : '#dc2626'
                    }}
                  >
                    {budgetMsg}
                  </p>
          ...
          <div className="app-card-soft">
            ...
            {summary?.forecast ? (
              <>
                ...
                >
                  This is a forecast based on spending patterns and is not
                  financial advice.
                </p>
              </>
            ) : (
            ...
            >
              <div>
                ...
                <select
                  ...
                  value={twinScenario}
                  onChange={(e) =>
                    setTwinScenario(e.target.value as typeof twinScenario)
                  }
                >
              ...
              >
                ...
                >
                  <div>
                    ...
                    >
                      {twinResult.currentBalanceDisplay}
                    </p>
                  </div>
                  <div>
                    <p style={{ fontSize: '0.7rem', color: '#6b7a90' }}>
                ...
                >
                  ...
                  >
                    {twinResult.impactLevel.charAt(0).toUpperCase() +
                      twinResult.impactLevel.slice(1)}
                  </span>
                </div>
